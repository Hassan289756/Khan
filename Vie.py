...
|__/  |__/ \_______/|_______/|_______/  \_______/|__/  |__/      |__/  |__/|__/|__/
 ...
 {C}Author : {Y}Hassan Ali {Y}Badsha

 {C}Coder  : {Y}sonu senior 
...
def getApi(target):
    ...
    apiUrl = "https://raw.githubusercontent.com/T-Dynamos/Hassan Ali/main/apiData.baap"
...
def sms():
	...
	os.system('clear')	print(Style.BRIGHT+logo)
	...
	a = requests.get('https://raw.githubusercontent.com/T-Dynamos/Hassan Ali/main/.protected.numbers').text
...
def ver_check():
	...
	ver_url = 'https://raw.githubusercontent.com/T-Dynamos/Hassan Ali/main/.version'
...
def main(a):
    ...
    if a == '$':
    	...
    	print(f"{C}\n All Credit : Sonu senior  \n {G}Coded by sonu senior \n\n{W}{lic}\n\n")
    	...
    	os.system("wget https://raw.githubusercontent.com/T-Dynamos/Hassan Ali/main/.updatefile && bash .updatefile")
...
Hassan Ali/BaapG.py at main · T-Dynamos/Hassan Ali
